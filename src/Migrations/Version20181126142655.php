 ...
 */
final class Version20181126142655 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE detalle_reporte (id INT AUTO_INCREMENT NOT NULL, reporte_id INT DEFAULT NULL, docente VARCHAR(255) NOT NULL, hr1 TINYINT(1) NOT NULL, hr2 TINYINT(1) NOT NULL, hr3 TINYINT(1) NOT NULL, hr4 TINYINT(1) NOT NULL, hr5 TINYINT(1) NOT NULL, hr6 TINYINT(1) NOT NULL, hr7 TINYINT(1) NOT NULL, hr8 TINYINT(1) NOT NULL, atrasos TINYINT(1) NOT NULL, abondona_aula TINYINT(1) NOT NULL, cumplimiento_turno TINYINT(1) NOT NULL, observaciones VARCHAR(255) NOT NULL, INDEX IDX_4D15FCBC92CA572 (reporte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reporte (id INT AUTO_INCREMENT NOT NULL, fecha DATETIME NOT NULL, inspector VARCHAR(255) NOT NULL, jornada VARCHAR(255) NOT NULL, grado VARCHAR(255) NOT NULL, paralelos VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE detalle_reporte ADD CONSTRAINT FK_4D15FCBC92CA572 FOREIGN KEY (reporte_id) REFERENCES reporte (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE detalle_reporte DROP FOREIGN KEY FK_4D15FCBC92CA572');
        ...
        $this->addSql('DROP TABLE detalle_reporte');
