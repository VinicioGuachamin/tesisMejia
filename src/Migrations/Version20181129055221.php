 ...
 */
final class Version20181129055221 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE asistencias (id INT AUTO_INCREMENT NOT NULL, codigobiometrico VARCHAR(255) NOT NULL, nombres VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, tipoempleado VARCHAR(255) NOT NULL, fecha DATETIME NOT NULL, tiempoatraso VARCHAR(255) NOT NULL, tiempoantes VARCHAR(255) NOT NULL, tiempoextra VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE asistencias');
