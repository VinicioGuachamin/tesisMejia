 ...
 */
final class Version20181012042456 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE horario (id INT AUTO_INCREMENT NOT NULL, lunes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', martes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', miercoles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', jueves LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', viernes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
